    ...
    Bitrum = (function () {
        ...
        function apply() {
            ...
            for (i = 0; i < arguments.length; i += 1) {
                ...
                console.log("asynch track", asyncTracker, f);
        ...
        function getBitrumUrlForOverlay(trackerUrl, apiUrl) {
            ...
            if (trackerUrl.slice(-9) === 'tracker/index/') {
        ...
        function Tracker(trackerUrl, siteId) {
            ...
            // Tracker URL
                configTrackerUrl = trackerUrl || 'http://192.168.0.50/ecmanalytics/index.php/tracker/index/',
            ...
            // My Custom data
                setMyCustomData,
            // My Custom data variables
                myCustomDataVariables = [],
            // user selected Items
                userSelectedItems = {};
            ...
            function getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
                var i,
                    ...
                    myCustomDataVariablesCopy = myCustomDataVariables;
                ...
                console.log(myCustomDataVariables, JSON2.stringify(myCustomDataVariables));
                request += '&myCustomData='+encodeWrapper(JSON2.stringify(myCustomDataVariables));
                // browser features
                ...
                console.log("in getReQuest", myCustomDataVariables);
                return request;
            }
            ...
            function logUserInfo(userData){
                ...
                request += '&user_items=' + encodeWrapper(JSON2.stringify(userData));
                request = getRequest(request, configCustomData, 'userInfo');
                sendRequest(request, configTrackerPause);
            ...
            return {
                ...
                setCustomVariable: function (index, name, value, scope) {
                    var toRecord;
                    console.log("custom varibales--", index, name, value, scope)
                    if (!isDefined(scope)) {
                        scope = 'visit';
                    }
                    if (!isDefined(name)) {
                 ...
                 * Set my custom data
                 */
                setMyCustomData: function (data, name, value, scope) {
                    console.log(data, name, value, scope);
                    myCustomDataVariables = data;
                    console.log("set my custom data", myCustomDataVariables);
                }
